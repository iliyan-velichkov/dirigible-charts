...
export class ShopRepository {
    ...
    private async triggerEvent(data: ShopEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("dirigible-charts-Shops-Shop", ["trigger"]);
        ...
        producer.topic("dirigible-charts-Shops-Shop").send(JSON.stringify(data));
    }
}
